...
///申请退款
class ApplyRefundView extends StatefulWidget {
  final String orderSn;

  const ApplyRefundView({Key key, @required this.orderSn}) : super(key: key);

  @override
  _GoodsEvaluationViewState createState() => _GoodsEvaluationViewState();
}

class _GoodsEvaluationViewState extends State<ApplyRefundView> {
...
//    var username = await SharedPreferencesUtils.getUserName();
