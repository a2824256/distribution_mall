...
class FillInOrderEntity extends Object {
  ...
  @JsonKey(name: 'integralDixiao')
  double integralDixiao;
  ...
  FillInOrderEntity(this.grouponRulesId,this.actualPrice,this.orderTotalPrice,this.cartId,this.couponId,this.goodsTotalPrice,this.addressId,this.grouponPrice,this.checkedAddress,this.couponPrice,this.availableCouponLength,this.freightPrice,this.integral,this.integralDixiao,this.checkedGoodsList,);
