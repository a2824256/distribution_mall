...
class Routers {
  ...
  static String goodsEvaluation = "/goodEvaluation";
  static String goodsComments = "/goodComments";
  static String applyRefund = "/applyRefund";
  static String applyExpress = "/applyExpress";
  ...
  static void configureRoutes(Router router) {
    ...
    router.define(goodsEvaluation, handler: goodsEvaluationHandler);
    router.define(goodsComments, handler: goodsCommentsHandler);
    router.define(applyRefund, handler: applyRefundHandler);
    router.define(applyExpress, handler: applyExpressHandler);
  }
}
